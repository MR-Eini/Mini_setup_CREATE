...
parameter_boundaries <- tibble::tibble(
  ...
  #surface runoff
  'cn2.hru | change = relchg' = c(0, 0.15),
  'cn3_swf.hru | change = absval' = c(0.5, 1), # Normalized range. Will be updated below
  'surlag.bsn | change = absval' = c(0.6, 2.5),
  ...
  'bd.sol | change = relchg' = c(0, 0.25),
  'k.sol | change = relchg' = c(-0.5, 1),
  # percolation/aquifer
  'perco.hru | change = absval' = c(0, 0.7), # Normalized range. Will be updated below
